...
| P0-T16 | in progress — bounded CPU reference slice | one in-memory dense decoder token: embedding gather, RMSNorm, projection, softmax and greedy argmax | packet `P0-T16`; independent oracle tests; no model/runtime/ABI/backend/GPU scope |
