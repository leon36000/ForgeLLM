...
| R-005 | A public-repository workflow reaches a privileged self-hosted GPU runner. | 4 | 5 | 20 | security owner | no runner until protected main, trusted-only triggers, environment approval, ephemeral workers, external review | any runner registration or fork-triggered job |
...
| R-013 | A secret, restricted asset or operational identifier is committed publicly. | 4 | 5 | 20 | security owner | public-data policy, deny-list, secret scanning, push protection, review and immediate rotation | scanner alert, public log or accidental payload |
...
| R-015 | Third-party apps or skills receive excessive permissions or retain data unexpectedly. | 3 | 5 | 15 | security owner | bounded tasks, least privilege, data classification, permission review and revocation | new integration or access expansion |
