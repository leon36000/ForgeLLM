...
**Version d’état :** S-0016
**Canonical state ID:** S-0016
...
**Statut global :** P0-T07, P0-T08/CA-03, P0-T11/P0-T12, P0-T13, P0-T14 et P0-T16 sont terminés; P0-T10 reste en `review` avec ADR-0005 `proposed`; P0-T15 reste `in_progress` comme tâche de conception uniquement avec ADR-0006 `proposed`; P0-T09/QG-01 reste actif mais inactif côté scanner; P0-T04 attend la désignation d’un hôte autorisé.
...
- dernier `main` protégé avant P0-T16 : `55d08c76b7fcdc3b6c256d35a4d74b275652964c` (PR #81, réparation de l’ancre lifecycle/state);
